...
package net.fakefabricmc.fabric.api.resource;
...
import net.fakefabricmc.fabric.impl.resource.loader.ResourceManagerHelperImpl;
...
public interface ResourceManagerHelper {
    ...
    static ResourceManagerHelper get(ResourceType type) {
        return (ResourceManagerHelper) ResourceManagerHelperImpl.get(type);
    }
