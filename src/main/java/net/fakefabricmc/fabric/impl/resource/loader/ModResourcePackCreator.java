...
package net.fakefabricmc.fabric.impl.resource.loader;
...
import net.fakefabricmc.fabric.api.resource.ModResourcePack;
...
public class ModResourcePackCreator implements ResourcePackProvider {
    ...
    public ModResourcePackCreator(ResourceType type) {
        this.type = type;
        this.factory = new ResourcePackProfile.Factory() {
            @Nullable
            @Override
            public ResourcePackProfile create(String string, Text arg, boolean bl, Supplier<ResourcePack> supplier, PackResourceMetadata arg2, ResourcePackProfile.InsertionPosition arg3, ResourcePackSource arg4, boolean bl2) {
                String name = new String();
                Text text = null;
                PackResourceMetadata metadata = null;
                ResourcePackProfile.InsertionPosition initialPosition = null;
                ResourcePackSource source = null;
                return new ResourcePackProfile(name, text, bl, supplier, metadata, type, initialPosition, source);
            }
        };
    }
